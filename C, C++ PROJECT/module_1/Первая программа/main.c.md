Начнём разбор базовой программы на языке С. По традиции будет вывод на экран фразы Hello World. Здесь мы используем функцию форматного вывода printf() подключаемую из файла stdio.h.
